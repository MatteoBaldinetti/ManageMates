...
<html lang="fr">
    ...
    <script src="http://ajax.googleapis.com/ajax/libs/jquery/1.7.1/jquery.min.js" type="text/javascript"></script>
        ...
        <script src="../js/displaySprint.js"></script>
        <script src="../js/createSprint.js"></script>
        <script src="../js/addCollaborator.js"></script>
        <script src="../js/addObjective.js"></script>
        <script src="../js/addUserstory.js"></script>
        <script src="../js/addBacklog.js"></script>
